...
class Publisher:
    ...
    def _write_latest(self,
        ...
        e.g. mesh_ply = "rosbags/scan_20260319_230358/mesh_final.ply"
        """
        payload = {
            "session":      session_id,
            "cloud_ply":    f"rosbags/{session_id}/{cloud_filename}" if cloud_filename else None,
            "mesh_ply":     f"rosbags/{session_id}/{mesh_filename}"  if mesh_filename  else None,
            "point_count":  point_count,
